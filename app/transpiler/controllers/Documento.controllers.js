...
const createDocumento = async ({ IdComplemento, Documentos, PersonaId }) => {
    if (Documentos) {
...
const updateDocumento = async ({ DocumentoId, IdComplemento, Documentos, PersonaId }) => {
    if (DocumentoId) {
        ...
        return (0, exports.createDocumento)({ IdComplemento: IdComplemento, Documentos: Documentos, PersonaId: PersonaId });
};
