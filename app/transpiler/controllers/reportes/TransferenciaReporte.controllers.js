...
exports.getReporteTransferenciasDetallado = exports.getReporteTransferenciasConsolidado = void 0;
 ...
 */
const getReporteTransferenciasConsolidado = async (req, res) => {
    try {
    ...
    `;
        const data = await Produccion_1.Produccion.query(sqlResumen, params);
        return res.json({
            metadatos: {
                desde: fechadesde,
                hasta: fechahasta,
...
exports.getReporteTransferenciasConsolidado = getReporteTransferenciasConsolidado;
/**
 * Reporte detallado de Transferencias (CON IMÁGENES)
 */
const getReporteTransferenciasDetallado = async (req, res) => {
    try {
        const { fechadesde, fechahasta, idsucursalorigen, idsucursaldestino, idempleado } = req.query;
        if (!fechadesde || !fechahasta)
        ...
        `;
        const data = await Produccion_1.Produccion.query(sqlTransferencias, params);
        // Calcular resumen global para el reporte
        const resumenGlobal = data.reduce((acc, curr) => {
...
exports.getReporteTransferenciasDetallado = getReporteTransferenciasDetallado;
