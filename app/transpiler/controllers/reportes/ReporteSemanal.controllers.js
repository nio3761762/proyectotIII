...
const getReporteSemanalVentas = async (req, res) => {
    try {
        ...
        const data = await Venta_1.Venta.query(`
...
exports.getReporteSemanalVentas = getReporteSemanalVentas;
const getReporteSemanalPedidos = async (req, res) => {
    try {
        const { fechadesde, fechahasta, idsucursal } = req.query;
        if (!fechadesde || !fechahasta)
            return res.status(400).json({ message: "Fechas obligatorias." });
        ...
        const data = await Pedido_1.Pedido.query(`
...
exports.getReporteSemanalPedidos = getReporteSemanalPedidos;
const getReporteSemanalProduccion = async (req, res) => {
    try {
        const { fechadesde, fechahasta, idsucursal } = req.query;
        if (!fechadesde || !fechahasta)
            return res.status(400).json({ message: "Fechas obligatorias." });
        ...
        const data = await Produccion_1.Produccion.query(`
...
exports.getReporteSemanalProduccion = getReporteSemanalProduccion;
const getReporteSemanalTransferencias = async (req, res) => {
    try {
        const { fechadesde, fechahasta } = req.query;
        if (!fechadesde || !fechahasta)
            return res.status(400).json({ message: "Fechas obligatorias." });
        const data = await db_1.AppDataSource.query(`
...
exports.getReporteSemanalTransferencias = getReporteSemanalTransferencias;
const getReporteSemanalCompras = async (req, res) => {
    try {
        const { fechadesde, fechahasta } = req.query;
        if (!fechadesde || !fechahasta)
            return res.status(400).json({ message: "Fechas obligatorias." });
        const data = await Compra_1.Compra.query(`
...
exports.getReporteSemanalCompras = getReporteSemanalCompras;
const getReporteSemanalGastosGenerales = async (req, res) => {
    try {
        const { fechadesde, fechahasta } = req.query;
        if (!fechadesde || !fechahasta)
            return res.status(400).json({ message: "Fechas obligatorias." });
...
exports.getReporteSemanalGastosGenerales = getReporteSemanalGastosGenerales;
const getReporteSemanalFinanciero = async (req, res) => {
    try {
        const { fechadesde, fechahasta, idsucursal } = req.query;
        if (!fechadesde || !fechahasta)
            return res.status(400).json({ message: "Fechas obligatorias." });
...
exports.getReporteSemanalFinanciero = getReporteSemanalFinanciero;
const getReporteSemanalComisiones = async (req, res) => {
    try {
        const { fechadesde, fechahasta, idsucursal } = req.query;
        if (!fechadesde || !fechahasta)
            return res.status(400).json({ message: "Fechas obligatorias." });
...
exports.getReporteSemanalComisiones = getReporteSemanalComisiones;
const getReporteSemanalKardex = async (req, res) => {
    try {
        const { fechadesde, fechahasta, idsucursal } = req.query;
        if (!fechadesde || !fechahasta)
            return res.status(400).json({ message: "Fechas obligatorias." });
...
exports.getReporteSemanalGeneral = getReporteSemanalGeneral;
