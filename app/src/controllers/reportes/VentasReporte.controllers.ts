 ...
 */
export const getReporteVentasConsolidado = async (req: Request, res: Response) => {
    try {
...
`;
        ...
        const [periodo, sucursales, productos, promociones, pagos, usuarios] = await Promise.all([
            Venta.query(sqlPeriodo, params),
            Venta.query(sqlSucursal, params),
            Venta.query(sqlProductos, params),
            Venta.query(sqlPromociones, params),
            Venta.query(sqlPagos, params),
            Venta.query(sqlUsuario, params)
        ]);
 ...
 */
export const getReportePedidosConsolidado = async (req: Request, res: Response) => {
    try {
        ...
        const [periodo, sucursales, estados, tipos, productos, clientes] = await Promise.all([
            Pedido.query(sqlPeriodo, params),
            Pedido.query(sqlSucursal, params),
            Pedido.query(sqlEstado, params),
            Pedido.query(sqlTipo, params),
            Pedido.query(sqlProductos, params),
            Pedido.query(sqlClientes, params)
        ]);
 ...
 */
export const getReportePedidosDetallado = async (req: Request, res: Response) => {
    try {
        ...
        const listado = await Pedido.query(sqlListado, params);
 ...
 */  
export const getReporteVentasDetallado = async (req: Request, res: Response) => {
    try {
        ...
        const [ventas, topCliente, topVendedor] = await Promise.all([
            ...
            Venta.query(sqlTopCliente, params),
            Venta.query(sqlTopVendedor, params)
        ]);
