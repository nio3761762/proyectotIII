...
import { createCategoria, createSubCategoria, deleteCategoria, deleteSubCategoria, getCategoria, getCategorias, getSubCategoria, getSubCategorias, updateCategoria, updateSubCategoria } from '../controllers/Categoria.controllers';
