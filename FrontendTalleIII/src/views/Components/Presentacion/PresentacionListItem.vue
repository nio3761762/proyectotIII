  ...
  >
    <div class="relative p-6">
      <div class="flex items-start justify-between mb-4">
        ...
        >
          {{ presentacion.Estado === 1 ? 'Activo' : 'Inactivo' }}
        </span>
      </div>
      <div class="flex gap-2">
        <button
          @click="$emit('edit', presentacion)"
        ...
        <button
          @click="$emit('toggle-status', presentacion.IdPresentacion, presentacion.Nombre, presentacion.Estado)"
          :class="[
        ...
        >
          <Trash2 v-if="presentacion.Estado === 1" class="h-4 w-4" />
