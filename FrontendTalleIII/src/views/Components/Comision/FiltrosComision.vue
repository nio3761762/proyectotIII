  ...
  <div class="bg-white/80 backdrop-blur-sm rounded-3xl shadow-xl border border-white/50 p-6">
    <div class="flex flex-wrap gap-3 items-end">
      ...
      <div class="min-w-[160px]">
        ...
        <select
          :value="idproducto"
          @change="$emit('update:idproducto', $event.target.value)"
          class="w-full py-2.5 px-3 border-0 shadow-md bg-gray-50/80 rounded-2xl text-sm text-gray-700 outline-none focus:bg-white focus:ring-2 focus:ring-orange-500/20 transition-all cursor-pointer"
        >
...
defineEmits(['update:search', 'update:estado', 'update:idproducto', 'update:limite']);
