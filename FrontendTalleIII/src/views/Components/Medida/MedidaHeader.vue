      ...
      <div class="flex items-center justify-between">
        <div class="flex items-center space-x-4">
          ...
          <div>
            ...
            <p class="text-gray-600 mt-1 font-medium">Administra todas las categorías de medidas y sus unidades</p>
          </div>
        </div>

        <div class="hidden md:flex items-center space-x-6">
          <div class="text-center">
            <div class="text-2xl font-bold text-gray-800">{{ categoriasActivas }}</div>
...
<script setup>
import { Ruler, TrendingUp } from 'lucide-vue-next';
