      ...
      <div class="flex items-center justify-between">
        <div class="flex items-center space-x-4">
          <div class="p-3 bg-gradient-to-br from-orange-500 to-red-600 rounded-2xl shadow-lg">
            <LayoutGrid class="h-8 w-8 text-white" />
          </div>
          <div>
            <h1 class="text-4xl font-bold bg-gradient-to-r from-orange-600 via-red-600 to-orange-700 bg-clip-text text-transparent">
              Gestión de Categorías
            </h1>
            <p class="text-gray-600 mt-1 font-medium">Administra todas las categorías y subcategorías</p>
          </div>
        </div>

        <div class="hidden md:flex items-center space-x-6">
          <div class="text-center">
            <div class="text-2xl font-bold text-gray-800">{{ categoriasActivos }}</div>
...
<script setup>
import { LayoutGrid, TrendingUp } from 'lucide-vue-next';
