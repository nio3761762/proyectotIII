      ...
      <div class="flex items-center justify-between">
        <div class="flex items-center space-x-4">
          ...
          <div>
            ...
            <p class="text-gray-600 mt-1 font-medium">Administra todas las sucursales de la empresa</p>
          </div>
        </div>

        <div class="hidden md:flex items-center space-x-6">
          <div class="text-center">
            <div class="text-2xl font-bold text-gray-800">{{ sucursalesActivas }}</div>
            <div class="text-sm text-gray-500">Activas</div>
          </div>
          <div class="w-px h-12 bg-gray-200"></div>
          <div class="text-center">
            <div class="text-2xl font-bold text-gray-800">{{ totalSucursales }}</div>
