...
<template>
  <div class="bg-white/80 backdrop-blur-sm rounded-3xl shadow-xl border border-white/50 p-6 mt-5">
    <div class="flex flex-col lg:flex-row gap-6 items-start lg:items-center justify-between">
      ...
      <div class="flex items-center gap-3">
        <button
          @click="$emit('nueva-sucursal')"
          class="bg-gradient-to-r from-orange-500 to-red-600 hover:from-orange-600 hover:to-red-700 text-white rounded-2xl px-6 py-3 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 flex items-center justify-center gap-2 font-medium"
        >
          <Plus class="h-4 w-4" />
          Nueva Sucursal
        </button>
...
defineEmits(['update:modelValue', 'nueva-sucursal']);
</script>
